...
export default async function SolicitacaoPage({ params }: SolicitacaoPageProps) {
  const { slug } = await params;
  
  // Pegar o primeiro segmento da slug (organizationSlug)
  ...
  // Log simples da slug (sem buscar organização, pois requer autenticação)
  console.log("=== DEBUG: Página de Solicitação ===");
  console.log("Organization Slug da URL:", organizationSlug);
  console.log("===================================");
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-950 dark:via-slate-900 dark:to-indigo-950">
        <div className="container mx-auto px-4 py-8 md:py-12">
          ...
          <div className="mx-auto max-w-3xl">
            <SolicitacaoForm organizationSlug={organizationSlug} />
          </div>
